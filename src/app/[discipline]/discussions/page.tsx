...
export default function DisciplineDiscussionsPage({ params }: { params: { discipline: string } }) {
  const discipline = getDisciplineBySlug(params.discipline);
  if (!discipline) notFound();

  const posts = getPostsByType("discussion", discipline.slug as DisciplineSlug);
